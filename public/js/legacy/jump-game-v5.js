import { jumpPatterns100, shuffledJumpPatterns } from "./jump-patterns-v5.js";
...
export function createJump(ctx) {
  ...
  hint.textContent = "낮은 장애물은 점프, 높은 벽은 2단 점프, 긴 천장은 꾹 숙여요.";
  ...
  function finishRun() {
    ...
    ctx.finish({ value: distance, display: distance.toFixed(1), unit: "m", higherBetter: true, mode: "jump-distance-v5", details: { distance, avoided, survivedSeconds: Number((elapsed / 1000).toFixed(1)) } });
  }
