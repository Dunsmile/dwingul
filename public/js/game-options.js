...
export function gameSettings(id, raw = {}) {
  ...
  return id === 'jump' ? { version: ['v4','v5','v6'].includes(raw.version) ? raw.version : 'v11' } : {};
}
...
export const gameModeNames = {
  ...
  'city-basic-v6':'도심 질주 · 시티 원', 'city-sport-v6':'도심 질주 · 스프린터', 'city-touring-v6':'도심 질주 · 롱런', 'jump-distance-v11':'멀리 뛰기 · 숲길 거리', 'jump-distance-v6':'멀리 뛰기 · 여유로운 2단 점프',
