...
test('character purchase and equip persist through an isolated server restart without changing gear',async()=>{
  ...
  try{
    ...
    const configured=await request('profile',{method:'POST',body:{nickname:'숲속 타자',pin:'2468'}});
    ...
    cookie='';
    const recovered=await request('recover',{method:'POST',body:{recovery:configured.recovery,pin:'2468'}});
