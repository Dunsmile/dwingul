...
await page.locator('[name=pin]').fill('Test-4177!');if(await page.locator('[name=passwordConfirm]').count())await page.locator('[name=passwordConfirm]').fill('Test-4177!');
...
await recoveredPage.locator('[name=pin]').fill('Test-4177!');if(await recoveredPage.locator('[name=passwordConfirm]').count())await recoveredPage.locator('[name=passwordConfirm]').fill('Test-4177!');
