...
test('garage validates replay, settles once independently of rankings, unlocks atomically, fixes challenge options',async()=>{
 ...
 try{
  ...
  await req('profile',{nickname:'운전자',pin:'Test-1234-password!'});assert.equal((await req('records',{run:attempt.id,scopes:['world'],country:'대한민국',result:{value:999999,mode:'city-sport-v4',display:'999999',unit:'m'}})).status,200);
