...
export function createApp({dbPath=path.join(root,localData,'dwingul.sqlite'),localTickets={},adminBootstrap}={}){
 ...
 const server=http.createServer(createApiHandler(db,{localOnly:true,localTickets,adminBootstrap,staticHandler}));
