...
v17 운영 반영 완료: PR7 main병합ad510e6, Cloudflare9c4c605c-61f2-4e57-a939-540ca65b6ceb. 운영14파일 SHA-256 일치, 관리robots 원본정책포함, 서버모듈404. 메모리QA서버 전부종료.

## v18 구현 및 검증 (2026-09-15)
슬라이딩 유지로 쉬워지는 코스를100개 행동 연계 조합으로 대체했다. 중간 높이 룬 돌 원화/양방향 회피,310→630가속, 점프 우선/급강하 재입력, 물리120Hz분할, v17동결/v18랭킹 분리를 적용했다. 전체291검사,1000연속경계, Chromium/WebKit320·390·1440px,6102m 실제화면 무피격 및 공식 게임 클라이언트 검증 통과. 상세 docs/releases/2026-09-15-v18.md. 운영 배포 확인은 다음 단계.

v18 운영 확인 완료: PR8 main병합2722a16, Cloudflare58a4baaa-0343-485b-9188-11436ad2702a. 운영17파일 SHA-256일치, 관리robots원본허용포함, 서버모듈404. 운영DB검증행 없음.

## v19 구현 및 검증 (2026-09-15)
고정 월드 간격의 83개 코스/4개 간격 변형, 최근 유사 코스 회피, 1000m 경계 연결과 시작4초 준비 구간을 적용했다. 3~6탄 템포1.08/1.16/1.24/1.40, 6탄 연속천장·낮고높은 묶음과 급강하 전환으로 조작 부담을 높였다. v18 동결 및 v19 기록 분리. 전체297검사, 모든 코스 양 경로/실제 템포,5seed6500m, Chromium/WebKit6뷰 및3회6512m, 공식 게임 클라이언트 검증 통과. 전체빌드30페이지/652아트/622전송이미지 성공. 상세 docs/releases/2026-09-15-v19.md. 운영배포확인 다음 단계.

v19 운영 확인 완료: PR9 main병합2f6862c, Cloudflare8ccef66d-d717-4b7c-97ac-4314a99b5c3c. 초기404 응답에서 v18복귀 후 같은 소스 재활성화; 최종15파일해시/관리robots/www308/서버모듈404/두브라우저운영ESM로드통과. 운영DB테스트행 없음. 사용자4173유지/QA서버종료. 남은 요청 작업 없음.

## v20 구현 및 검증 (2026-09-16)
타이핑 제목 화면 시작→모험 설정→실제 시작 순서로 변경하고 선택 모드/스테이지를 보존했다. 점프 캔버스·버튼만 iOS 선택/길게누르기 메뉴/기본터치동작을 차단하며 장시간 숙이기와 다중 터치를 유지했다. 변경전 흐름실패·WebKit버튼선택가능상태 재현, 신규6뷰 및 기존타이핑12뷰, 전체297검사, 공식게임클라이언트/정적빌드 통과. iOS전용 네이티브번역팝업의 실기기확인은 환경상 미실시; desktopWebKit검증과 구분. 상세 docs/releases/2026-09-16-v20.md. 운영확인 다음단계.

v20 운영반영완료: PR10 main병합e36178b, Cloudflareb8229d6c-12ff-4c69-a39c-441460dbc7b5. 운영8파일해시/robots/www308/서버모듈404확인. QA서버종료/사용자4173유지. 코드·검증·배포완료; 아이폰실기기 네이티브팝업 검증은 미실시로 명확히 안내.
